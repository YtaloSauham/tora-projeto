export default function Jumbotron(){
    return(
        ...
        <span className="flex w-min-[54px] justify-center h-[54px] w-[162px] font-bold rounded-md bg-black text-white-300"><a className="text-center flex items-center" href="">Baixar</a></span>
        </div>
